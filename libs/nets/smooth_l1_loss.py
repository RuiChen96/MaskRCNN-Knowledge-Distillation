...
def smooth_l1_loss(bbox_preds, bbox_targets, \
                   bbox_inside_weights, bbox_outside_weights, sigma=3.0):
    """
    As in Caffe implementation, the bbox_preds and bbox_targets
    should be a 2-dim torch Variable.
    """
    sigma2 = sigma ** 2
